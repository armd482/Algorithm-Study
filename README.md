...
![1074 exa](https://user-images.githubusercontent.com/89967066/158965626-e17f0022-6a93-4923-8e87-0cf52fb54385.png)
<br/>
4개의 사분면을 나눠서, 입력받은 행과 열의 범위에 따라 결국은, 기본 n-1일 때의 값을 처음 시작값에 더해주면 되는 방식을 생각했다.
그리고하여 n=3일 때를 봤을 때, 각 사분면의 시작 번호가 각각 0, 16, 32, 48로 이는 2^(2*n-2)의 배수로 
<br/>
<br/>
